...
<?php require_once("includes/navigation.php"); ?>
    ...
    <div class="background-img">
        ...
        <div>
            <div class=" background-text">
                <h1 class="">
                    Explore Bangladesh With Trip Planner</h1>
        ...
        <div class="container-fluid">
                <div class=" col-md-11  image-form-div"
                     style="background: #F8F8F8;  border-radius: 10px; box-shadow: 3px 3px 10px gray; margin-top: 20px;">
                    <form action="showdirection.php" method="post" class="form-inline image-form">
                        <div class="form-group">

                            <input type="text" name="currentLoc" class="form-control " placeholder="Your Location">
                            <input type="text" name="destinationLock" class="form-control " placeholder="Your Direction">
                            <div class="input-group input-daterange">
                                <input type="datetime-local" class="form-control" name="startdate" placeholder="Start Tour ">
                                <div class="input-group-addon"><i class="glyphicon glyphicon-arrow-right"></i></div>
                                <input type="date" class="form-control" name="enddate" placeholder="End Tour">
                            </div>
                            <select class="form-control" style="width: 160px;" name="member" title="Member">
                            ...
                            <input type="submit" name="submit" value="Make A Plan"
                                   class=" btn btn-primary form-control   submit-btn button-book-now"
                                   style="width: 160px;">
    ...
    <!--Slider End-->
    <!--Easy to use, easy to browse Start-->
    <div class="container">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="col-md-12">
                        <div class="circle col-md-offset-2 circle-logo "><i class="fa fa-map-marker fa-4x"
                                                                            aria-hidden="true"
                                                                            style="margin: 20px 35px"></i></div>

                    </div>
                </div>
                <div class="col-md-3">
                    <div class="col-md-12">
                        <div class="circle col-md-offset-2 circle-logo "><i class="fa fa-calendar-check-o fa-4x"
                                                                            aria-hidden="true"
                                                                            style="margin: 20px 23px"></i></div>

                    </div>
                </div>
                <div class="col-md-3">
                    <div class="col-md-12">
                        <div class="circle col-md-offset-2 circle-logo "><i class="fa fa-plane fa-4x" aria-hidden="true"
                                                                            style="margin: 20px 25px"></i></div>

                    </div>
                </div>
                <div class="col-md-3">
                    <div class="col-md-12">
                        <div class="circle col-md-offset-2 circle-logo "><i class="fa fa-suitcase fa-4x"
                                                                            aria-hidden="true"
                                                                            style="margin: 20px 21px"></i></div>
    ...
    <!--Easy to use, easy to browse End-->
            ...
            <div class="container-img">
                ...
                <div class="shuffle-group">
                    <div data-si-mousemove-trigger="100" class="shuffle-me">
                        <a href="#" class="info a_info" target="_blank"><h1 class=" h1_info">The Cox's Bazar</h1>
                        ...
                        <div class="images">
                            ...
                            <img src="Images1/sail-the-fishing-boat-is-coxs-bazar-tour-with-deshghuri.jpg"
                                 style="height: 432px">
                            <img src="Images1/HT_barbados_MEM_151120_16x9_992.jpg" style="height: 430px">
                        </div>
                    </div>
                    <div class="shuffle-me">
                        <a href="http://blog.bucketlistly.com/post/67843428144/trekking-the-himalayas-annapurna-base-camp-in-7"
                           class="info a_info" target="_blank"><h1 class=" h1_info">The Bandarban</h1>
                    ...
                    <div class="shuffle-me">
                        <a href="http://blog.bucketlistly.com/post/59584109323/incredible-india-a-solo-travelers-journal-3"
                           class="info a_info" target="_blank"><h1 class=" h1_info">The Sajek Valley</h1>
                ...
                <div class="shuffle-group">
                    <div data-si-mousemove-trigger="100" class="shuffle-me">
                        <a href="http://blog.bucketlistly.com/post/59584109323/incredible-india-a-solo-travelers-journal-3"
                           class="info a_info" target="_blank"><h1 class=" h1_info">The Sundarbans</h1>
                    ...
                    <div class="shuffle-me">
                        <a href="http://blog.bucketlistly.com/post/86313792387/africa-part-1-exploring-soweto-on-a-bike-solo"
                           class="info a_info" target="_blank"><h1 class=" h1_info">Mosque city bagaerhat</h1>
                    ...
                    <div class="shuffle-me">
                        <a href="http://blog.bucketlistly.com/post/67843428144/trekking-the-himalayas-annapurna-base-camp-in-7"
                           class="info a_info" target="_blank"><h1 class=" h1_info">The sonargaon</h1>
                ...
                <div class="shuffle-group">
                    <div data-si-mousemove-trigger="100" class="shuffle-me">
                        <a href="http://blog.bucketlistly.com/post/59584109323/incredible-india-a-solo-travelers-journal-3"
                           class="info a_info" target="_blank"><h1 class=" h1_info">The Stlhet</h1>
                        ...
                        <div class="images">
                            ...
                            <img src="Images1/sylhet/private-tour-sylhet-full-day-tour-of-ratargul-and-bisnakandi-in-sylhet-343163.jpg"
                                 style="height: 430px">
                    ...
                    <div class="shuffle-me">
                        <a href="http://blog.bucketlistly.com/post/86313792387/africa-part-1-exploring-soweto-on-a-bike-solo"
                           class="info a_info" target="_blank"><h1 class=" h1_info">The dhaka</h1>
                        ...
                        <div class="images">
                            ...
                            <img src="Images1/dhaka/main-qimg-0c239c2785b0ca7071e57d17ff21bd10-c.jpg"
                                 style="height: 210px; width: 320px">
                            <img src="Images1/dhaka/25c10333782950.56b81cc695b41.jpg"
                                 style="height: 210px; width: 320px">
                    ...
                    <div class="shuffle-me">
                        <a href="http://blog.bucketlistly.com/post/67843428144/trekking-the-himalayas-annapurna-base-camp-in-7"
                           class="info a_info" target="_blank"><h1 class=" h1_info">The Kuakata</h1>
    ...
    <div class="container">
        <h2 class="no-background"><span class="span-heading">Make Plan In The City</span></h2>

    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-8">
                <!--my map postition start-->
              <!--  <script src="https://maps.google.com/maps/api/js?sensor=false&key=AIzaSyC0gnjDKRXILSK2Auei7w8uln9DxrE6qgI"></script>-->

                <!--my map position end-->
                <div id="map" class="thumbnail">  <div id="mapholder" > Your Location Is Not Available </div> </div>
            </div>
            <div class="col-md-4 " style="margin-left: -50px;
   		margin-top: 38px;">
                <h3 style="margin-left: 13px;"> Visit popular city of Bangladesh</h3>
                <div class="col-md-8">
                    <h4>Dhaka city</h4>
                    <p>Dhaka is the capital city of Bangladesh.</p>
                    <h5>Vist beautiful place of Dhaka in 4 days</h5>
                    <div style="margin-top: -8px;">
                        <a href="#">Make a plan<span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span></a>
                    </div>
                </div>
            ...
            <div class="col-md-4 " style="margin-left: -50px;">
                ...
                <div class="col-md-8">
                    <h4>Chittagong city</h4>
                    <p>large port city of Bangladesh</p>
                    <h5>Vist beautiful place of Dhaka in 4 days</h5>
                    <div style="margin-top: -8px;">
                        <a href="#">Make a plan<span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span></a>
                    </div>
            ...
            <div class="col-md-4 " style="margin-left: -50px;">
                ...
                <div class="col-md-8">
                    <h4>Sylhet city</h4>
                    <p>Sylhet is a city in eastern Bangladesh. </p>
                    <h5>Vist beautiful place of Dhaka in 4 days</h5>
                    <div style="margin-top: -8px;">
                        <a href="#">Make a plan<span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span></a>
                    </div>
            ...
            <div class="col-md-4 " style="margin-left: -50px;">
                ...
                <div class="col-md-8">
                    <h4>Rajshahi city</h4>
                    <p>Rajshahi is a metropolitan city in Bangladesh</p>
                    <h5>Vist beautiful place of Dhaka in 4 days</h5>
                    <div style="margin-top: -8px;">
                        <a href="#">Make a plan<span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span></a>
                    </div>
            ...
            <div class="col-md-4 " style="margin-left: -50px;">
                ...
                <div class="col-md-8">
                    <h4>Cox's Bazar city</h4>
                    <p>Have Longest Sea Beach in the world</p>
                    <h5>Vist beautiful place of Dhaka in 4 days</h5>
                    <div style="margin-top: -8px;">
                        <a href="#">Make a plan<span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span></a>
                    </div>
