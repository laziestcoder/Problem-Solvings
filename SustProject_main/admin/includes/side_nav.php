    ...
    <ul class="nav navbar-nav side-nav">
        ...
        <li>
            ...
            <ul id="hotels" class="collapse">
                ...
                <li>
                    <a class="fa fa-bed" href="hotels.php?source=view_registered_hotel">View Registered Hotels</a>
                </li>
                <li>
                    <a class="fa fa-bed" href="hotels.php?source=view_registered_hotel">Edit Hotel Info</a>
                </li>
            </ul>
        </li>
