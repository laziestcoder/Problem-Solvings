...
<div class="container">
    <div class=" col-sm-8 col-sm-offset-2" style="background-color: white; height: 400px;">
        <div  class="text-center"  style="background-color: #358CCE; color: white;margin-top: -20px ;margin-left: -15px; height: 70px; margin-right: -15px">
        ...
        <div>
            ...
            <a class="btn btn-primary col-sm-2 col-sm-offset-5" style="height: 40px; font-size: 20px; margin-top: 100px;" href="index.php">OK</a>
        </div>
