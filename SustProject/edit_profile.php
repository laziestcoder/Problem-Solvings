      ...
      <!--  </div>-->  <!--cover div-->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="text-center">
                    <img src="images/users/<?php echo $user->user_image; ?>" class="avatar img-circle img-thumbnail"
                         alt="user_picture"  style="height:300px; width:400px; border-top-right-radius:10px; border-bottom-left-radius: 10px; ">
            ...
            <div class="col-md-6 personal-info">
                ...
                <h3 style="padding-left: 90px">My Information</h3>
                <hr>
                <br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" name="fullname" value="<?php echo $user->fullname; ?>" type="text"
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" name="contact" value="<?php echo $user->mobile_no; ?>" type="text"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input class="form-control" name="password" id="password" value="<?php echo $user->password; ?>" type="password"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input class="form-control" id="confirm_password" value="<?php echo $user->password; ?>" type="password"
